...
If you want to build Bithold-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a bithold-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the bithold directory
BDB_PREFIX="${BITHOLD_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure Bithold Core to use our own-built instance of BDB
cd $BITHOLD_ROOT
./autogen.sh
...
2) The release is built with GCC and then "strip bitholdd" to strip the debug
symbols, which reduces the executable size by about 90%.


To Build Bitholdd with compile script
---------------------
...
Security
---------------------
To help make your bithold installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, bithold should be built with a non-executable stack
