...
QString BitcoinUnits::name(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("μBHD");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Bitholds");
    case mBTC: return QString("Milli-Bitholds (1 / 1,000)");
    case uBTC: return QString("Micro-Bitholds (1 / 1,000,000)");
    default: return QString("???");
    }
}
