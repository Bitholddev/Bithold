...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Bithold", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Bithold</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017-2018 The Bithold developers", Q_NULLPTR));
