...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 BHD"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 BHD"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 BHD"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 BHD"));
